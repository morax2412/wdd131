...
const temples = [
  ...
  // ------------------------------
  // Added 3+ temples (you can change these)
  // ------------------------------
  {
    ...
    area: 42100,
    imageUrl:
      "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/laie-hawaii/400x250/laie-hawaii-temple-lds-1002271-wallpaper.jpg"
  },
  {
    ...
    area: 48480,
    imageUrl:
      "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/sapporo-japan/400x250/sapporo-japan-temple-lds-1913173-wallpaper.jpg"
  },
  {
    ...
    area: 22184,
    imageUrl:
      "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/kyiv-ukraine/400x250/kyiv-ukraine-temple-lds-916384-wallpaper.jpg"
  }
];
...
// ------------------------------
// Build ONE card (template literal)
// ------------------------------
...
// ------------------------------
// Filtering logic (conditional branching + array.filter)
// ------------------------------
...
function init() {
  ...
  nav.addEventListener("click", (event) => {
    ...
    const filtered = filterTemples(filterName);
